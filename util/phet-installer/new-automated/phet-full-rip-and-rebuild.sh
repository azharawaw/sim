...
function send_email_notification {
   ...
   EMAIL_ADDR="john.blanco@colorado.edu vcs@pixelzoom.com olsonsjc@gmail.com reids@colorado.edu katherine.perkins@colorado.edu oliver.nix@colorado.edu steele.dalton@colorado.edu"
